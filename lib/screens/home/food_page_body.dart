              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    return GestureDetector(
                      onTap: (){
                        Get.toNamed(RouteHelper.getRecommendedFood(index) ,arguments: {'pageId': index.toString()});
                      },
                      child: Container(
        ...
        children: [
          GestureDetector(
            onTap: (){
              ...
              Get.toNamed(RouteHelper.getPopularFood(index), arguments: {'pageId': index.toString()});
            },
            child:Container(
